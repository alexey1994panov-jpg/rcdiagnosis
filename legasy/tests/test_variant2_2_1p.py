...
def test_variant2_next_occupied_dual_phase3() -> None:
    data = {
        "station": "Visochino",
        "target_rc": "1P",
        "dt": 1,
        ...
        "steps": [
            # Фаза 1: 3 шага prev=0, curr=0, next=1 (0-0-1)
            *[
                {
                    "t": 1,
            ...
            # Фаза 2: 4 шага prev=0, curr=1, next=1 (0-1-1)
            *[
                {
                    "t": 1,
            ...
            # Фаза 3: 3 шага prev=0, curr=0, next=0 (0-0-0) → вариант 2.2
            *[
                {
                    "t": 1,
            ...
            # Завершение ДС: ещё 3 шага 0-0-0 для Ткон
            *[
                {
                    "t": 1,
                    "rc_states": {"10-12SP": 3, "1P": 3, "1-7SP": 3},
    ...
    # Для отладки можно временно оставить вывод
