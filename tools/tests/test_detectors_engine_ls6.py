...
def run_ls6_test(ctrl_rc_id, adj_rc_id, nc_side, sig_id, sw_states, branch="6.1"):
    """
    РЈС‚РёР»РёС‚Р° РґР»СЏ Р·Р°РїСѓСЃРєР° С‚РµСЃС‚Р° LS6.
    nc_side: "prev" РёР»Рё "next"
    branch: "6.1" (Prev NC) РёР»Рё "6.2" (Next NC)
    """
    det_cfg = DetectorsConfig(
        ctrl_rc_id=ctrl_rc_id,
        # РњС‹ РќР• РёРЅРёС†РёР°Р»РёР·РёСЂСѓРµРј РёРјРµРЅР° СЃРѕСЃРµРґРµР№ РІ РєРѕРЅС„РёРіРµ, 
        # С‡С‚РѕР±С‹ РїСЂРѕРІРµСЂРёС‚СЊ СЂР°Р±РѕС‚Сѓ РґРёРЅР°РјРёС‡РµСЃРєРѕР№ С‚РѕРїРѕР»РѕРіРёРё!
        enable_ls6=True,
        ts01_ls6=1.0,
        tlz_ls6=1.0,
        tkon_ls6=2.0,
    ...
    scenario = [
        ...
        # Phase KOGDA: 2-4СЃ -> РѕС‚РєСЂС‹С‚РёРµ
        ScenarioStep(
            t=2.0,
        ...
        # Р—Р°РІРµСЂС€РµРЅРёРµ: 4-7СЃ -> Р·Р°РєСЂС‹С‚РёРµ
        ScenarioStep(
            t=3.0,
...
def test_ls6_endpoints():
    ...
    # 1. Р§Рџ (40). Neighbor 36. Switch 2 (32).
...
def test_ls6_rc65_failure():
    ...
    # 4Рџ (65). Neighbor 36. Switch 2 (32). Position Minus (0).
